<div className="lg:block hidden">
  <div className="bg-white p-6 rounded-lg border-2 border-gray-800 shadow-xl"> {/* Aumenté el grosor del borde y mejoré la sombra */}
    <div className="bg-gray-900 p-3 rounded-t-md flex items-center gap-2"> {/* Aumenté el padding */}
      <div className="w-3 h-3 rounded-full bg-red-500"></div>
      <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
      <div className="w-3 h-3 rounded-full bg-green-500"></div>
      <span className="text-sm text-white ml-2">HubSeguros - Panel de control</span>
    </div>
    <div className="bg-white p-6 rounded-b-md"> {/* Aumenté el padding */}
      <div className="grid grid-cols-3 gap-6"> {/* Aumenté el gap */}
        <div className="bg-[#E8F0FF] p-4 rounded-md text-center">
          <div className="text-3xl font-bold text-blue-700 mb-1">124</div> {/* Aumenté el tamaño del texto y agregué margen inferior */}
      ...
      <div className="mt-6"> {/* Aumenté el margen superior */}
        <div className="flex justify-between items-center mb-3"> {/* Agregué margen inferior */}
          <h4 className="font-semibold text-lg">Vencimientos próximos</h4> {/* Aumenté el peso de la fuente y el tamaño */}
          <h4 className="font-semibold text-lg">Tareas pendientes</h4>
        </div>
        <div className="grid grid-cols-2 gap-6"> {/* Aumenté el gap */}
          <div>
            <div className="bg-white border-2 rounded-md p-3 mb-3"> {/* Aumenté el grosor del borde y los márgenes */}
